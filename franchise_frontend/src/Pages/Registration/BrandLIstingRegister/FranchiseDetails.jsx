...
import categories from "./BrandCategories"; // Assuming categories.json is in the same directory
    ...
    <Box sx={{ mt: 2 }}>
      ...
      >
        ...
        <Grid item xs={12} sm={6} md={2.4}>
          <FormControl
            fullWidth
            error={!!errors["fico[0].investmentRange"]}
            required
          >
        ...
        <Grid item xs={12} sm={6} md={2.4}>
          <FormControl
            fullWidth
            error={!!errors["fico[0].franchiseModel"]}
            required
          >
        ...
        <Grid item xs={12} sm={6} md={2.4}>
          <FormControl
            fullWidth
            error={!!errors["fico[0].franchiseType"]}
            required
          >
      ...
      >
        {/* <Grid>
          <FormControl
            component="fieldset"
            fullWidth
            error={!!errors.internationalExpansion}
            required
          >
            <FormLabel component="legend">
              Are You Looking For Internation Expansion
            </FormLabel>
      ...
      <Grid item xs={12}>
        ...
        >
          <Grid item>
            ...
            >
              <FormLabel component="legend">
                Do you have a Strategic Business plan? to drive your business
              </FormLabel>
          ...
          <Grid item>
            ...
            >
              <FormLabel component="legend">
                Do you have a Standard Operating procedure for your franchise
                business?
              </FormLabel>
              <Box sx={{ display: "flex", flexDirection: "column" }}>
          ...
          <Grid item>
            ...
            >
              <FormLabel component="legend">
                Do you have a Financial Operating procedure for your franchise
                business?
              </FormLabel>
              <Box sx={{ display: "flex", flexDirection: "column" }}>
          ...
          <Grid item>
            ...
            >
              <FormLabel component="legend">
                Do you have a Marketing and Sales plan to expand across India?
              </FormLabel>
              <Box sx={{ display: "flex", flexDirection: "column" }}>
