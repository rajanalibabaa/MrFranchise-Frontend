...
const ShareDialogActions = ({ anchorEl, setAnchorEl }) => {
  ...
  const socialPlatforms = [
    ...
    },
    {
      ...
      icon: <Twitter />,
      color: "primary",
      url: `https://twitter.com/intent/tweet?url=${encodeURIComponent(currentUrl)}&text=${encodeURIComponent(shareText)}&hashtags=ShareWithFriends`,
      action: 'share'
    },
    {
      name: "LinkedIn",
      ...
      <Dialog open={urlDialogOpen} onClose={handleUrlDialogClose}>
        ...
        <DialogContent>
          ...
          <Typography variant="body2" color="text.secondary">
            The link will include a preview with our brand logo when shared on social media.
          </Typography>
        </DialogContent>
        <DialogActions>
