...
//       "https://franchise-backend-wgp6.onrender.com/api/v1/view/getAllViewBrandByID"
//     );
//     return response.data.data; // Assuming the API returns data in a 'data' field
//   };

//   const { data: brands = [], isLoading, error } = useQuery({
//     queryKey: ['viewerBrands'],
//     queryFn: fetchBrands
//   });

//   // Like mutation
//   const { mutateAsync: toggleLikeMutation } = useMutation({
//     mutationFn: async ({ brandId, isLiked }) => {
...
//         `https://franchise-backend-wgp6.onrender.com/api/v1/brand/like/${brandId}`,
//         {},
//         {
//           headers: {
...
//     },
//     onSuccess: () => {
//       queryClient.invalidateQueries({ queryKey: ['viewerBrands'] });
//     }
//   });

//   // Post view
//   const postView = async (brandId) => {
//     try {
//       await axios.post(
//         `https://franchise-backend-wgp6.onrender.com/api/v1/view/postView/${brandId}`
//       );
//     } catch (error) {
...
//   // Open brand dialog (simplified)
//   const openBrandDialog = (brand) => {
//     navigate(`/brand/${brand.uuid}`, { state: { brand } });
//   };
...
//     try {
//       await toggleLikeMutation({ brandId, isLiked });
//     } catch (error) {
