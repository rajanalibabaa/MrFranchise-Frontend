...
const BrandDashBoard = ({ selectedSection, sectionContent }) => {
 ...
 useEffect(() => {
  ...
  const handleTabChange = (_, newValue) => {
    console.log("newViewType :",newValue)
    setViewType("")
    if (newValue === 1) {
  ...
  const renderUserCard = (item, name, imageSrc, type = 'user') => (
    console.log(item.uuid,imageSrc),
        ...
        >
          <ToggleButton value="brands" aria-label="brand views">
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              ...
              <Typography variant="body1">Brand Views</Typography>
              <Box sx={{
                backgroundColor: theme.palette.primary.main,
                color: 'white',
                borderRadius: '50%',
          ...
          <ToggleButton value="investors" aria-label="investor views">
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              ...
              <Typography variant="body1">Investor Views</Typography>
              <Box sx={{
                backgroundColor: theme.palette.primary.main,
                color: 'white',
                borderRadius: '50%',
