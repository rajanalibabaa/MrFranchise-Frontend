...
function BrandList() {
  ...
  const handleOpenBrand = async(brand) => {
    ...
    const viewResponse = await axios.post(`https://franchise-backend-wgp6.onrender.comhttps://franchise-backend-wgp6.onrender.com/api/v1/view/postViewBrands/${Id}`,
      {viewedID:brand.uuid},
      {
          headers: {
            "Content-Type": "application/json",
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(
                "https://franchise-backend-wgp6.onrender.comhttps://franchise-backend-wgp6.onrender.com/api/v1/brandlisting/createInstaApply",
                payload,
                {
                    headers: {
                        "Content-Type": "application/json",
