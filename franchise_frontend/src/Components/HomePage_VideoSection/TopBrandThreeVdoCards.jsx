...
//     (state) => state.brands
//   );
// console.log("3 cards brands",brands)
...
//   // Auto-play main video when it changes
//   useEffect(() => {
//     if (mainVideoRef.current && brands.length > 0) {
...
//     >
      ...
      // <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 3, px: isMobile ? 2 : 0 }}>
      //   <Typography
...
//                     muted={true}
//                     ref={(el) => {
//                       videoRefs.current[0] = el?.videoRef || null;
//                       mainVideoRef.current = el?.videoRef || null;
//                     }}
//                   />
//                 </Box>
                ...
                // }}>
                //   <Stack direction={{ xs: "column", sm: "row" }} alignItems={{ xs: "flex-start", sm: "center" }} ml={{ xs: 2 }} mt={1} spacing={1}>
                //     <Stack direction="row" spacing={1} alignItems="center" sx={{ minWidth: 0, flex: 1, paddingBottom: "10px" }}>
                //       {isMobile && (
                //         <Avatar
...
//               <Button
//                 variant="contained"
//                 onClick={viewedBrandsCount >= brands.length - 1 ? handleLoadMore : handleNext}
...
//               }}>
                ...
                //     loop={true}
                //     muted={true}
                //     ref={(el) => (videoRefs.current[i + 1] = el?.videoRef || null)}
                //   />
                //   <Chip
                ...
                //       <Typography variant="caption" color="Black" sx={{ fontSize: "0.7rem", lineHeight: 1.5 }}>
...
//   DialogTitle,
// } from "@mui/material";
// import { ChevronRight, ChevronLeft, FavoriteBorder, Favorite } from "@mui/icons-material";
// import { motion, AnimatePresence } from "framer-motion";
// import { useTheme } from "@mui/material/styles";
...
//     height: { xs: 500, sm: 480, md: 550 },
//     videoHeight: { xs: 275, sm: 300, md: 450 },
//   },
//   side: {
//     width: { xs: "100%", sm: "100%", md: "30%" },
//     height: { xs: 200, sm: 220, md: 260 },
//     videoWidth: { xs: "40%", sm: "45%", md: "58%" },
//   },
// };

// const Fact = React.memo(({ label, value }) => (
//   <Typography variant="body2" color="text.secondary" noWrap>
//     <strong>{label}:</strong>&nbsp;{value || "Not Specified"}
//   </Typography>
// ));

// const MainBrandCard = React.memo(({ 
//   brand, 
//   isMobile, 
//   theme, 
//   handlePrev, 
...
//   handleLoadMore,currentIndex, totalCount,
// }) => {
//   return (
//     <Card sx={{
//       height: CARD_SIZES.main.height,
...
//             </Box>
//             <Box sx={{ position: "absolute", top: 16, right: 16, zIndex: 2 }}>
//                {(currentIndex === totalCount - 1 && hasMore) ? (
//                 <Button
//                   variant="outlined"
//                   aria-label="next brand"
...
//                         sx={{ color: brand.isLiked ? "red" : "gray" }}
//                       >
//                         {brand.isLiked ? <Favorite color="error" /> : <FavoriteBorder />}
//                       </IconButton>
//                     </Tooltip>
//                   )}
//                 </Box>
...
//               <Typography variant="body2" noWrap overflow="hidden" textOverflow="ellipsis" color="text.secondary">
//                 {brand.brandCategories?.child || "N/A"}
//               </Typography>
//             </Box>
//           </Stack>
...
//           <Stack direction={{ xs: "row" }} alignItems={{ xs: "flex-start", sm: "center" }} spacing={6}>
//             <Stack direction="column" spacing={1}>
//               <Fact label="Investment" value={brand.fico?.investmentRange} />
//               <Fact label="Area Required" value={brand.fico?.areaRequired} />
//               <Fact label="Franchise Model" value={brand.fico?.franchiseModel} />
//               {isMobile && (
//                 <Button
//                   variant="contained"
//                   aria-label="view details"
...
// const SideBrandCard = React.memo(({ 
//   brand, 
//   index, 
//   isMobile, 
//   theme, 
...
//           flexShrink: 0,
//         }}
//         onClick={() => togglePlayPause(index + 1)}
//       >
//         <VideoPlayer
//           key={brand.uuid}
//           id={brand.uuid}
...
//         />
//         <Chip
//           label={index === 0 ? "Trending" : "Popular"}
//           size="small"
//           sx={{
//             position: "absolute",
//             top: 8,
...
//   const mainBrand = useMemo(() => brands[currentIndex] || null, [brands, currentIndex]);
//   const nextBrands = useMemo(() => [
//     brands[(currentIndex + 1) % brands.length],
//     brands[(currentIndex + 2) % brands.length],
//   ].filter(Boolean), [brands, currentIndex]);
...
//     return () => clearTimeout(timeoutRef.current);
//   }, [currentIndex, isHovered, brands.length, handleNext]);
...
//         {/* Main Video Card */}
//         <Box sx={{
//           flex: { xs: "1 1 auto", md: "0 0 68%" },
//           maxWidth: CARD_SIZES.main.width,
//           minWidth: { xs: "100%", md: "68%" },
//           position: "relative",
//         }}>
//           <MainBrandCard
//             brand={mainBrand}
...
//               <Button
//                 variant="contained"
//                 onClick={currentIndex === brands.length - 1 ? handleLoadMore : handleNext}
//                 endIcon={isLoading ? <CircularProgress size={20} sx={{ color: "inherit" }} /> : <ChevronRight />}
//                 disabled={!hasMore && currentIndex === brands.length - 1}
//                 fullWidth
//                 sx={{
...
//                 {isLoading
//                   ? "Loading..."
//                   : currentIndex === brands.length - 1 && hasMore
//                   ? "Load More"
//                   : "Next"}
//               </Button>
//             </Box>
...
// export default React.memo(TopBrandVdoCards);
