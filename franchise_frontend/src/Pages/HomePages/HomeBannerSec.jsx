...
//     { component: "TopFoodFranchise", background: "#white" },
//     { component: "TopBeverageFranchise", background: "#white" },
//     { component: "LikedBrands", background: "#white" },
//     { component: "TopCafeFranchises", background: "#white" },
//     { component: "TopDesertBakeryFranchise", background: "#white" },
//     { component: "TopTruckAndKiosks", background: "#white" },
...
// // LazyCard component with IntersectionObserver
...
//       {inView ? (
//         <Suspense fallback={<div style={{ height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><CircularProgress size={24} color="success" /></div>}>
...
// function LazySection({ componentKey, dynamicComponents, background, ...props }) {
//   const Component = dynamicComponents[componentKey];
//   const [ref, inView] = useInView({
//     triggerOnce: true,
//     rootMargin: "200px",
