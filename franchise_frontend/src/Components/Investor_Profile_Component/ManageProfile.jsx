...
const ManageProfile = () => {
  ...
  const handleRequestOtp = async () => {
    ...
    try {
      const response = await axios.post(
        "https://franchise-backend-wgp6.onrender.comhttps://franchise-backend-wgp6.onrender.com/api/v1/otp/existingEmailOTP",
  ...
  const handleOtpVerify = async () => {
    ...
    try {
      const response = await axios.post(
        "https://franchise-backend-wgp6.onrender.comhttps://franchise-backend-wgp6.onrender.com/api/v1/otp/verifyExistingEmailOTP",
        {
          email: investorData.email,
          verifyOTP: otp,
        },
  ...
  const handleSave = async () => {
    ...
    try {
      const response = await axios.patch(
        `https://franchise-backend-wgp6.onrender.comhttps://franchise-backend-wgp6.onrender.com/api/v1/investor/updateInvestor/${investorUUID}`,
        formData,
        {
          headers: {
  ...
  const handleConfirm = async () => {
    try {
      ...
      const response = await axios.patch(
        `https://franchise-backend-wgp6.onrender.comhttps://franchise-backend-wgp6.onrender.com/api/v1/investor/deleteInvestorProfileImage/${investorUUID}`,
