...
const [showLogin, setShowLogin] = useState(false);
    ...
    const fetchData = async () => {
      try {
        ...
        if (response) {
          ...
          const processedBrands = brand.map((brand) => {
            ...
            return {
              ...brand,
              locations: expansionLocations.length
                ? expansionLocations
                : ["Multiple Locations"],
  ...
  const filteredBrands =
    selectedValue && selectedValue !== "All Locations"
    ...
    >
      ...
      >
        ...
        >
          ...
          <Typography variant="body1" color="text.secondary">
            ...
            {filteredBrands.length === 1 ? "Opportunity" : "Opportunities"}{" "}
            Available
          </Typography>
        </Box>
      </Box>
      ...
      >
        {filteredBrands.map((brand, index) => {
          ...
          const category =
            brand?.personalDetails?.brandCategories?.[0]?.child ||
            "No category";
          ...
          return (
            <motion.div
              ...
              style={{
                ...
                flexShrink: 0,
                marginRight:
                  index === filteredBrands.length - 1 ? (isMobile ? 2 : 3) : 0,
              }}
            >
              <Card
                sx={{
