...
const BrandDetails = ({ data = {}, onChange, errors = {} }) => {
  ...
  const sendOtp = async (type) => {
    ...
    if (type === "email") {
      ...
      endpoint = "https://franchise-backend-wgp6.onrender.comhttps://franchise-backend-wgp6.onrender.com/api/v1/otpverify/send-otp-email";
      payload = { email: data.email, type: "email" };
    } else if (type === "mobile") {
      fieldName = "mobileNumber";
      fieldValue = data.mobileNumber;
      endpoint = "https://franchise-backend-wgp6.onrender.comhttps://franchise-backend-wgp6.onrender.com/api/v1/otpverify/send-otp-mobile";
      payload = { mobile: `${phoneCode}${data.mobileNumber}`, type: "mobile" };
    } else if (type === "whatsapp") {
      fieldName = "whatsappNumber";
      fieldValue = data.whatsappNumber;
      endpoint = "https://franchise-backend-wgp6.onrender.comhttps://franchise-backend-wgp6.onrender.com/api/v1/otpverify/send-otp-whatsapp";
  ...
  const verifyOtp = async () => {
    ...
    try {
      const response = await axios.post(
        "https://franchise-backend-wgp6.onrender.comhttps://franchise-backend-wgp6.onrender.com/api/v1/otpverify/verify-otp",
        {
