...
import { fetchBrands, setFilters, clearFilters, openBrandDialog,
  closeBrandDialog } from "../../Redux/Slices/brandSlice.jsx"
import BrandDetailsDialog from "./BrandDetailsDialog.jsx";
...
function BrandList() {
  ...
  const { openDialog, selectedBrand } = useSelector(
    (state) => state.brands
  );

  const handleOpenBrand = (brand) => {
    dispatch(openBrandDialog(brand));
    console.log("jjjjjjjjjjj",brand)
  };
