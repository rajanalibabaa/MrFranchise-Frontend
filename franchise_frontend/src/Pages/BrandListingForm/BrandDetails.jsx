...
const BrandDetails = ({ data = {}, onChange, errors = {} }) => {
  ...
  const sendOtp = async (type) => {
    ...
    if (type === "email") {
      ...
      endpoint = "https://mrfranchisebackend.mrfranchise.in/otpverify/send-otp-email";
      payload = { email: data.email, type: "email" };
    } else if (type === "mobile") {
      fieldName = "mobileNumber";
      fieldValue = data.mobileNumber;
      endpoint = "https://mrfranchisebackend.mrfranchise.in/otpverify/send-otp-mobile";
      payload = { mobile: `${phoneCode}${data.mobileNumber}`, type: "mobile" };
    } else if (type === "whatsapp") {
      fieldName = "whatsappNumber";
      fieldValue = data.whatsappNumber;
      endpoint = "https://mrfranchisebackend.mrfranchise.in/otpverify/send-otp-whatsapp";
